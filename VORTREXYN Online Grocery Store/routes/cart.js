...
router.get('/payment', (req, res) => {
  ...
  const freeThreshold = tier >= 6 ? 0 : tier === 5 ? 150 : tier === 4 ? 100 : tier === 3 ? 150 : tier === 2 ? 100 : 50;
  ...
  const autoDiscountPct = tier >= 7 ? 25 : tier >= 6 ? 20 : tier === 5 ? 15 : tier === 4 ? 10 : 0;
...
router.post('/payment', (req, res) => {
  ...
  const discountRate  = tier >= 7 ? 3.50 : tier >= 6 ? 3.00 : tier === 5 ? 2.50 : tier === 4 ? 2.00 : tier === 3 ? 1.50 : tier === 2 ? 1.00 : 0.50;
  const autoDiscPct   = tier >= 7 ? 25 : tier >= 6 ? 20 : tier >= 5 ? 15 : tier === 4 ? 10 : 0;
